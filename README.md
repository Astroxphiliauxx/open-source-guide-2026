...
A comprehensive, curated list of open source programs, internships, competitions, and university initiatives with updated timelines for **2025-2026**.
...
| [**Processing Foundation Fellowship**](https://processingfoundation.org/fellowships/) | Processing Foundation | Annual applications | Varies | Open to all |
| [**Igalia Coding Experience**](https://www.igalia.com/coding-experience/) | Igalia | Rolling applications | Paid | Open to all |
| [**Linux Kernel Mentorship**](https://wiki.linuxfoundation.org/lkmp) | Linux Foundation | Aligns with LFX terms | Stipend available | Open to all |
| [**John Hunter Matplotlib Fellowship**](https://numfocus.org/programs/john-hunter-technology-fellowship) | NumFOCUS | Summer months | Funded | Students |
| [**Google Summer of Earth Engine**](https://sites.google.com/view/summerofearthengine/) | Google | Summer months | Funded | Indian university students |
| [**FOSSASIA Internship**](https://fossasia.org/internship) | FOSSASIA | Rolling | Varies | Open to all |
| [**Millennium Fellowship**](https://www.millenniumfellows.org/) | United Nations | Annual cohorts | Non-paid (leadership program) | University students |
...
| [**FOSSASIA CodeHeat**](https://codeheat.org/) | FOSSASIA | Year-round with cycles | Cash prizes, gadgets |
| [**Data Driven Competitions**](https://www.drivendata.org/competitions/) | DrivenData | Various deadlines | Cash prizes |
| [**Halite AI Bot Challenge**](https://halite.io/) | Two Sigma | Seasonal | Recognition, prizes |
| [**OSS World Challenge**](https://www.oss.kr/en_oss_world_challenage) | Ministry of Science, Korea | Annual | Cash prizes |
| [**ACM MM Open Source Software Competition**](http://sigmm.org/Resources/software/ossc) | ACM SIGMM | Aligns with ACM MM conference | Awards |

---

## 🎓 University Open Source Programs

> Student-led initiatives from universities around the world to promote open source development.
...
| [**JGEC Winter of Code**](https://jwoc.tech/) | JGEC | December - January | India (Online) |
| [**NJACK Winter of Code**](https://njackwinterofcode.github.io/) | IIT Patna | December - January | India (Online) |
| [**OpenCode IIITA**](https://opencodeiiita.github.io/) | IIIT Allahabad | Winter months | India (Online) |
| [**Delta Winter of Code (DWoC)**](https://dwoc.io/) | NIT Trichy | December - January | India (Online) |
| [**IIIT-K Winter of Code**](https://gdsc-woc.tech/) | IIIT Kalyani (GDSC) | December - January | India (Online) |
| [**DevScript Winter of Code**](https://devscript.tech/woc/) | DevScript | December - January | India (Online) |
| [**Cross Winter of Code**](https://crosswoc.ieeedtu.in/) | IEEE DTU | December - February | India (Online) |
| [**Semester Long Projects (SLoP)**](https://slop.dscdaiict.in/) | DA-IICT | Semester-based | India (Online) |
| [**Hack Club SRM SoC**](https://github.com/Hack-Club-SRM/HCSSoC) | SRM University | Summer months | India (Online) |
| [**OSS Summer of Innovation**](https://oss2019.github.io/SoI.html) | Community | Summer months | India (Online) |
| [**FOSSEE Summer Fellowship**](https://fossee.in/) | IIT Bombay | Summer months | India |
| [**Winter of Code by NSEC**](https://winterofcode.com/) | Netaji Subhash Engineering College | Winter months | India (Online) |
...
- Season of KDE
- 24 Pull Requests
- University Winter/Summer of Codes

### 🌍 Region-Specific Programs
| Region | Programs |
|--------|----------|
| **India** | KWOC, SWOC, SSoC, GSSoC, FOSSEE Fellowship, University WoCs |
| **USA** | MLH Fellowship (priority), some LFX programs |
| **Belgium** | Open Summer of Code Belgium |
| **Korea** | OSS World Challenge |
| **Global** | GSoC, Outreachy, LFX, Hacktoberfest |
...
- Verify dates are current for the active year
